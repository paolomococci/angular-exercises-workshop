...
const ELEMENT_DATA: Element[] = [
  ...
  {atomic:79, symbol:'Au', name:'Gold', group:'transition metal', mass:196.96657, weight:197, radioactive:false, artificially:false},
  ...
  {atomic:84, symbol:'Po', name:'Polonium', group:'metalloid', mass:208.98243, weight:209, radioactive:true, artificially:false},
  {atomic:85, symbol:'At', name:'Astatine', group:'halogen', mass:209.98715, weight:210, radioactive:true, artificially:false},
  {atomic:86, symbol:'Rn', name:'Radon', group:'noble gas', mass:222.01758, weight:222, radioactive:true, artificially:false},
  {atomic:87, symbol:'Fr', name:'Francium', group:'alkali metal', mass:223.01973, weight:223, radioactive:true, artificially:false},
  {atomic:88, symbol:'Ra', name:'Radium', group:'Alkaline earth metal', mass:226.02541, weight:226, radioactive:true, artificially:false},
  {atomic:89, symbol:'Ac', name:'Actinium', group:'actinide', mass:227, weight:227.02775, radioactive:true, artificially:false},
  {atomic:90, symbol:'Th', name:'Thorium', group:'actinide', mass:232.0381, weight:232, radioactive:true, artificially:false},
  {atomic:91, symbol:'Pa', name:'Protactinium', group:'actinide', mass:231.03588, weight:231, radioactive:true, artificially:false},
  {atomic:92, symbol:'U', name:'Uranium', group:'actinide', mass:238.0289, weight:238, radioactive:true, artificially:false},
  {atomic:93, symbol:'Np', name:'Neptunium', group:'actinide', mass:237.048172, weight:237, radioactive:true, artificially:true},
  {atomic:94, symbol:'Pu', name:'Plutonium', group:'actinide', mass:244.0642, weight:244, radioactive:true, artificially:true},
  {atomic:95, symbol:'Am', name:'Americium', group:'actinide', mass:243.06138, weight:243, radioactive:true, artificially:true},
  {atomic:96, symbol:'Cm', name:'Curium', group:'actinide', mass:247.07035, weight:247, radioactive:true, artificially:true},
  {atomic:97, symbol:'Bk', name:'Berkelium', group:'actinide', mass:247.07031, weight:247, radioactive:true, artificially:true},
  {atomic:98, symbol:'Cf', name:'Californium', group:'actinide', mass:251.07959, weight:251, radioactive:true, artificially:true},
  {atomic:99, symbol:'Es', name:'Einsteinium', group:'actinide', mass:252.083, weight:252, radioactive:true, artificially:true},
